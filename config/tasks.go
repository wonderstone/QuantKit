...
// NewScheduler will create a new scheduler instance that allows users to create and manage tasks.
...
func (schd *Scheduler) AddWithID(id string, t *Task) error {
	...
	if t.Interval <= time.Duration(0) && !t.RunOnce {
